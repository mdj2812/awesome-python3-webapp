...
env.host_string = '106.54.26.52' # 改成你的服务器ip
env.key_filename = 'conf/test_server_key'
db_user = 'www-data'
...
def deploy():
    ...
    with cd(_REMOTE_BASE_DIR):
        ...
        sudo('chown ubuntu:ubuntu www') # user改为你的linux服务器上的用户名
        sudo('chown -R ubuntu:ubuntu %s' % newdir) # 同上
